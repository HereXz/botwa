...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/52a9862e26a52b4a390e2.png',"thumbnail": thumb,"sourceUrl": `https://taaofc-panel.my.id`}}}, { quoted:m})} 
